...
function nf_get_settings(){
  ...
  $settings['date_format'] = isset ( $settings['date_format'] ) ? $settings['date_format'] : '';
  $settings['currency_symbol'] = isset ( $settings['currency_symbol'] ) ? $settings['currency_symbol'] : '';
  $settings['req_div_label'] = isset ( $settings['req_div_label'] ) ? $settings['req_div_label'] : '';
  $settings['req_field_symbol'] = isset ( $settings['req_field_symbol'] ) ? $settings['req_field_symbol'] : '';
  $settings['req_error_label'] = isset ( $settings['req_error_label'] ) ? $settings['req_error_label'] : '';
  $settings['req_field_error'] = isset ( $settings['req_field_error'] ) ? $settings['req_field_error'] : '';
  $settings['spam_error'] = isset ( $settings['spam_error'] ) ? $settings['spam_error'] : '';
  $settings['honeypot_error'] = isset ( $settings['honeypot_error'] ) ? $settings['honeypot_error'] : '';
  $settings['timed_submit_error'] = isset ( $settings['timed_submit_error'] ) ? $settings['timed_submit_error'] : '';
  $settings['javascript_error'] = isset ( $settings['javascript_error'] ) ? $settings['javascript_error'] : '';
  $settings['invalid_email'] = isset ( $settings['invalid_email'] ) ? $settings['invalid_email'] : '';
  $settings['process_label'] = isset ( $settings['process_label'] ) ? $settings['process_label'] : '';
